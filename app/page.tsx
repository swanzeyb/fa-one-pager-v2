              ...
              <Tabs defaultValue="short-summary" className="w-full">
                  ...
                  <div className="p-4 border rounded-md">
                    ...
                    <ScrollArea className="h-[calc(100vh-300px)]">
                      {outputs.shortSummary ? (
                        <MarkdownRenderer content={outputs.shortSummary} editable={true} />
                      ) : (
                  ...
                  <div className="p-4 border rounded-md">
                    ...
                    <ScrollArea className="h-[calc(100vh-300px)]">
                      {outputs.mediumSummary ? (
                        <MarkdownRenderer content={outputs.mediumSummary} editable={true} />
                      ) : (
                        <p className="text-sm text-muted-foreground">
                ...
                <TabsContent value="how-to-guide" className="mt-4">
                  <div className="p-4 border rounded-md">
                    ...
                    <ScrollArea className="h-[calc(100vh-300px)]">
                      {outputs.howToGuide ? (
                        <MarkdownRenderer content={outputs.howToGuide} editable={true} />
                      ) : (
                        <p className="text-sm text-muted-foreground">
